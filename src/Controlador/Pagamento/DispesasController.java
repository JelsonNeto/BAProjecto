 ...
 * @author Familia Neto
 */
public class DispesasController implements Initializable {
    @FXML
  ...
  //*******************METODOS OPERACIOANAIS****************************************/
    ...
    private void SetCampos( String ano )
    {
        int valorp = Pagamento_Salario.TotalSalario_por_funcao("Professor(a)", ano);
        int valorl = Pagamento_Salario.TotalSalario_por_funcao("Limpeza", ano);
        int valordg = Pagamento_Salario.TotalSalario_por_funcao("Director geral", ano);
        int valordp = Pagamento_Salario.TotalSalario_por_funcao("Director Pedagógico", ano);
        int valor_sec = Pagamento_Salario.TotalSalario_por_funcao("Secretário(a)", ano);
        int valor_cont = Pagamento_Salario.TotalSalario_por_funcao("Contabilista", ano);
        int valors = Pagamento_Salario.TotalSalario_por_funcao("Segurança", ano);
        int valor_coord = Pagamento_Salario.TotalSalario_por_funcao("Coordenador(a)",ano);
        int d_adamin = Pagamento_Salario.TotalSalario_por_funcao("Director Administrativo",ano);
        int sub_admin = Pagamento_Salario.TotalSalario_por_funcao("Subdirector Administrativo",ano);
        ...
        lbl_v_limpeza.setText(DefinicoesUnidadePreco.RetornaValorEmUnidadeCorrecta(""+valorl));
        ...
        lbl_v_dir_admin.setText(DefinicoesUnidadePreco.RetornaValorEmUnidadeCorrecta(""+d_adamin));
